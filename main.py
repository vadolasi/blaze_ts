    ...
    while True:
        try:
            ...
            if item_number == 0:
                ...
                if item_minute > soma_esquerdo_1 - 1 and item_minute < soma_esquerdo_1 + 1 or item_minute > soma_direito_1 - 1 and item_minute < soma_direito_1 + 1 or item_minute > soma_2_lados_1 - 1 and item_minute < soma_2_lados_1 + 1 or item_minute > soma_2_esquerdo_1 - 1 and item_minute < soma_2_esquerdo_1 + 1 or item_minute > soma_2_direito_1 - 1 and item_minute < soma_2_direito_1 + 1 or item_minute > soma_esquerdo_2 - 1 and item_minute < soma_esquerdo_2 + 1 or item_minute > soma_direito_2 - 1 and item_minute < soma_direito_2 + 1 or item_minute > soma_2_lados_2 - 1 and item_minute < soma_2_lados_2 + 1 or item_minute > soma_2_esquerdo_2 - 1 and item_minute < soma_2_esquerdo_2 + 1 or item_minute > soma_2_direito_2 - 1 and item_minute < soma_2_direito_2 + 1:
